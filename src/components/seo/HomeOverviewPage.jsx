...
const HomeOverviewPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-16 md:py-24 px-4 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12 md:mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                        {[
                            ...
                            <a
                                key={index}
                                href={item.href}
                                className="group bg-white/5 hover:bg-white/10 p-6 rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 text-center backdrop-blur-sm"
                            >
                                <div className="w-12 h-12 bg-naijaGreen/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                    <div className="text-naijaGreen">
                                        {item.icon}
                                    </div>
                                </div>
