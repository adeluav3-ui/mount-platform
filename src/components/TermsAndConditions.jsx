                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3 text-gray-700">
                                            <p>
                                                <strong>1.1 Deposit Payment:</strong> Upon accepting a quote, you agree to pay a 50% deposit. This deposit secures your booking and covers initial material costs for the service provider.
                                            </p>
                                            <p>
                                            ...
                                            <p className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                                                <span className="font-bold text-red-600">⚠️ Legal Consequences:</span> Failure to pay the final balance constitutes breach of contract. We reserve the right to:
